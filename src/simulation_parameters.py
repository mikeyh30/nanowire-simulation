...
simulation_parameters = dict(
    ...
    muSc=[19.9E-3], # [1.4E-6], # [0.22] # [2.2E-25], #Chemical potential in the nanowire.
    mu=[18E-3], # [1.9E-6],  # [0.3] # [3E-25], # Chemical potential in the semiconductor
    delta=[180E-6], # [45E-6],  # [0.1] # [7.2E-24], # superconducting gap
    barrier=[100E-3], # [12.5E-6],  # [2.0] # [2.0E-24], # find out more about this.
    b_max=[10],  # T
)
