...
def gen_blank_output_csv(date, scratch):
    ...
    if not os.path.exists(filename):
        text = "wire_width,wire_length,barrier_length,stagger_ratio,period,M,m_max,hopping_distance,added_sinusoid,B,b_max,bohr_magneton,alpha_R,delta,gfactor,effective_mass,mu_wire,mu_barrier,mu_lead,barrier_height"
