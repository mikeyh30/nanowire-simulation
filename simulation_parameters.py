...
simulation_parameters = dict(
    ...
    M = [0.1], #[1],#B field strength from nanomagnets.
    added_sinusoid = [True], # Indicates presence of nanomagnets
    ## SOI terms ##
    effective_mass=[0.5],#[0.019*electron_mass], # m^*_{InAs}
    alpha=[0.0],#[5.1E-30], #Rashba parameter
    muSc=[0.22],#[2.2E-25], #Chemical potential in the nanowire.
    mu=[0.3],#[3E-25], # Chemical potential in the semiconductor
